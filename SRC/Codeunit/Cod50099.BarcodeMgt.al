codeunit 50099 "BarcodeMgt"
{
    ...
    procedure EncodeEAN13(pcodBarcode: Code[250]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "Barcode Details" temporary)
    var
    ...
    begin
        ...
        precTmpTempBlob."Barcode Image 13".CREATEOUTSTREAM(loutBmpHeader);
    ...
    procedure EncodeCode128(pcodBarcode: Code[1024]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "Barcode Details" temporary)
    var
        lrecTmpCode128: Record BarcodePrinting temporary;
        lintCount1: Integer;
    ...
    begin
        ...
        precTmpTempBlob."Barcode Image128".CREATEOUTSTREAM(loutBmpHeader);
    ...
    procedure EncodeCode39(pcodBarcode: Code[1024]; pintSize: Integer; pblnCheckDigit: Boolean; pblnVertical: Boolean; var precTmpTempBlob: record "Barcode Details" temporary)
    var
        lrecTmpCode39: Record BarcodePrinting temporary;
        lintCount1: Integer;
        lintSum: Integer;
        lintConvInt: Integer;
        lintCheckDigit: Integer;
    ...
    begin
        ...
        precTmpTempBlob."Barcode Image 39".CREATEOUTSTREAM(loutBmpHeader);
    ...
    procedure EncodeEAN8(pcodBarcode: Code[250]; pintSize: Integer; pblnVertical: Boolean; var precTmpTempBlob: Record "Barcode Details" temporary)
    var
        ltxtWeight: Text[12];
        ltxtSentinel: Text[3];
        ltxtCenterGuard: Text[6];
    ...
    begin
        ...
        precTmpTempBlob."Barcode Image EAN 8".CREATEOUTSTREAM(loutBmpHeader);
    ...
    local procedure InitCode128(var precTmpCode128: Record BarcodePrinting temporary)
    begin
        precTmpCode128.INIT;
    ...
    local procedure InitCode39(var precTmpCode39: Record BarcodePrinting temporary)
    begin
    ...
    procedure EncodeCode1282(pcodBarcode: Code[1024])
    var
        precTmpTempBlob: Record "Barcode Details" temporary;
        lrecTmpCode128: Record BarcodePrinting temporary;
        lintCount1: Integer;
        ltxtArray: array[2, 200] of Text[30];
        lcharCurrentCharSet: Char;
    ...
    begin
        ...
        precTmpTempBlob."Barcode Image128".CREATEINSTREAM(StreamIn);
        DOWNLOADFROMSTREAM(StreamIn, 'Save Barcode', 'E:\', '*.jpg', a);
    end;
}
